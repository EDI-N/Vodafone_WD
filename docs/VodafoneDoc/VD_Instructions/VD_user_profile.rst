...
Для налаштування користувацького профілю потрібно клікнути лівою кнопкою мишки на іконку користувача та обрати **"Профіль користувача"** (`налаштування панелі адміністратора <https://vodafone-wd-wiki.edin.ua/uk/latest/VodafoneDoc/WD_Instructions/WD_admin_panel.html>`__ описані в окремій інструкції):
...
У вкладці відображаються активні запрошення до мейлбокса чи аккаунта інших користувачів сервісу (запрошення відправляються з `"Панелі адміністратора" - Користувачі <https://vodafone-wd-wiki.edin.ua/uk/latest/VodafoneDoc/WD_Instructions/WD_admin_panel.html#users>`__), що потребують рішення:
