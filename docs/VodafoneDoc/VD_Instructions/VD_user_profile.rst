...
* **Персональні налаштування** - блок, що містить персональні дані користувача (ім'я, прізвище), налаштування мови інтерфейсу сервісу VodafoneDoc, часовий пояс, uuid користувача (не доступно до редагування), email користувача (не доступно до редагування) і налаштування мейлбокса, що буде відкриватись при вході в сервіс.
