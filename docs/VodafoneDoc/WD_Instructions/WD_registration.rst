...
Для початку роботи в сервісі **VodafoneDoc** потрібно здійснити авторизований вхід (https://wd.edin.ua/login).
...
Для самостійної реєстрації (https://wd.edin.ua/login) потрібно натиснути на кнопку **"Створити акаунт"**:
...
При створенні (https://wd.edin.ua/registration) особистого акаунта обов'язково потрібно ввести ім'я, прізвище, електронну пошту, пароль та натиснути кнопку **"Створити акаунт"**:

.. image:: pics_WD_registration/WD_registration_004.png
   :align: center

.. note::
   Для реєстрації також обов'язково ознайомитись з правилами користування сервісом (https://wd.edin.ua/legal-information/terms).
...
При створенні (https://wd.edin.ua/registration) акаунта компанії також обов'язково потрібно ввести ім'я, прізвище, електронну пошту, пароль та **додатково** вказати ЄДРПОУ/ІПН і назву компанії, що буде відображатись контрагентам та натиснути кнопку **"Продовжити"**:
