Робота з конвертами сервісу VodafoneDoc
###################################################################
...
В сервісі VodafoneDoc для конвертів передбачені наступні статуси:
...
.. tip::
    Перед початком роботи з конвертами рекомендовано ознайомитись з інструкцією по роботі з `шаблонами <https://wiki.edin.ua/uk/latest/VodafoneDoc/WD_Instructions/Work_with_VD.html#template>`__.
...
.. hint::
    В збереженій чернетці можливо обмінюватись коментарями |comment| (`детальніше про функціонал Коментарів <https://wiki.edin.ua/uk/latest/VodafoneDoc/WD_Instructions/Work_with_Envelope.html#comments>`__)
...
Відправлений конверт в статусі "В обробці" чи "Очікує на вас" (на стороні поточного заповнювача/підписанта) можливо **"Відхилити"**. Для відхилення конверта обов'язково потрібно вказати причину відхилення і підтвердити відхилення:
